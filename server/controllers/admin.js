...
class AdminController {
    ...
    async signIn(req, res) {
        ...
        try {
            ...
            const match = await bcrypt.compare(receivedPassword, activeUser.adminPassword);
    ...
    async signUp(req, res) {
        ...
        try {
            ...
            const newUser = await admin.create({ name: receivedName, adminPassword: hashedPassword });
            const payload = {
                check: true,
                _id: newUser._id,
                admin:true
