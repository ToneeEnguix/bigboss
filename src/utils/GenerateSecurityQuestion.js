...
export default React.memo((props) => {
  ...
  const correctResult = operators[randomOperator].method(
    randomNumber01,
    randomNumber02
  );
...
const Results = (props) => {
  ...
  return (
    <React.Fragment>
      <h3
        css={{ fontSize: "0.7rem", marginTop: "1rem", letterSpacing: "0.2rem" }}
      >
        SECURITY QUESTION: WHAT IS {props.stringOperation}?
      </h3>
