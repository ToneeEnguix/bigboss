export const formatDate = (string) => {
    ...
    const monthNumber = array[2].substring(0, 2);
    const month = monthName(monthNumber);
    const dayString = dayName(array[1]);
    array[1] = dayString;
    array[2] = month;
return array
...
const dayName = (numberString) => {
    ...
    const dayDenominations = ["FIRST", "SECOND", "THIRD", "4TH",
        "5TH", "6TH", "7TH", "8TH", "9TH", "10TH", "11TH", "12TH", "13TH", "14TH",
        "15TH", "16TH", "17TH", "18TH", "19TH", "20TH", "21ST", "22SND", "23ST", "24TH", "25TH",
