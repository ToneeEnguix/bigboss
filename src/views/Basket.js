...
function Basket() {
  ...
  const checkoutProcess = async () => {
    ...
    if (result.ok && result.data.modified === false) {
      ...
      setMessage({
        visibility: "visible",
        message: "YOUR CART WAS MODIFIED. CHECK AND PROCEED",
      });
          ...
          <div css={compsColumn}>
            {context.user.cart.length > 0 ? (
              context.user.cart.map((competition, index) => {
                return (
                  <BasketCard
                    key={competition._id + competition.amount}
          ...
          <div css={dataColumn}>
            <div css={summary}>
              ...
              >
                ...
                <p css={{ fontWeight: "600", fontSize: "0.7rem" }}>
                ...
                <button
                  onClick={redeem}
                  css={{ color: "white", letterSpacing: "0.1rem" }}
                  className="button02"
                >
                  REDEEM PROMO CODE
                </button>
                ...
                <div css={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  {discountAmount > 0 ? (
                    <p css={{ fontWeight: "500" }}>-£{discountAmount}</p>
                  ) : null}
                </div>
                <hr />
                <div css={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <p css={{ fontWeight: "500" }}>
                    £{(partialAmount - discountAmount).toFixed(2)}
                  </p>
                </div>
                {context.user.cart.length > 0 ? (
                  <button
