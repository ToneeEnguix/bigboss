    ...
    <div css={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <div css={detailsColumn}>
          ...
          <h3 css={{ margin: "1rem 0 2rem 0", color: "#00FFFF" }}>
            ONLY £{data.ticketPrice} PER ENTRY
          </h3>
          ...
          <div css={{ display: "flex", alignItems: "center" }}>
            ...
            <button onClick={substract} className="roundButton">
              —
            </button>
            <button onClick={add} className="roundButtonBlue">
              +
            </button>
          ...
          <div css={mq({ width: ["100%"] })}>
            ...
            {data.description.map((line, index) => {
              return (
                <p
                  key={index}
                  css={{ padding: "0.5rem 0", textTransform: "uppercase" }}
                >
                  {line}
                </p>
              );
